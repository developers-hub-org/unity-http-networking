<?php
    ...
    define('PHONE_VERIFICATION_CODE_EXPIRE_TIME', 120);
    define('EMAIL_VERIFICATION_CODE_EXPIRE_TIME', 600);
    define('PASSWORD_RECOVERY_EMAIL_CODE_EXPIRE_TIME', 600);
define('PASSWORD_RECOVERY_PHONE_CODE_EXPIRE_TIME', 120);
?>
